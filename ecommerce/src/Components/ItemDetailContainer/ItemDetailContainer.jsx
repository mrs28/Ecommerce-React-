    ...
    <div className={styles.itemDetail}>
      ...
      <div className={styles.itemDetailDescription}>
        ...
        <Slider className={styles.slider}
            ...
            >
              <div>
                <img className={styles.sliderImg} src={idProductSelected.img} alt="foto1" 
                width={140}
                height={140} />
              </div>
              <div>
                <img className={styles.sliderImg} src={idProductSelected.img}alt="foto2"  width={140}
                height={140}  />
              </div>
              <div>
                <img className={styles.sliderImg}  src={idProductSelected.img} alt="foto3"  width={140}
                height={140}   />
              </div>
          </Slider>
        </div>
